    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              Alanya Çeyiz Evi olarak, el işi ve özel tasarım çeyiz ürünleriyle
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/urunler" className="text-gray-400 hover:text-white transition-colors">
                  Ürünler
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/sss" className="text-gray-400 hover:text-white transition-colors">
                  SSS
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Alanya Çeyiz Evi. Tüm hakları saklıdır.</p>
        </div>
      </div>
    </footer>
  );
